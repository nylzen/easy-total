...
export const ProductItem = ({ product }) => {
  ...
  const DeleteButton = ({ className = "" }) => (
    <button
      ...
      className={`p-2 rounded-lg bg-gray-800 text-gray-400 hover:text-red-400 transition-colors ${className}`}
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              {product.quantity > 1 && <DeleteButton />}
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-1 bg-gray-800 rounded-lg p-1">
              {product.quantity === 1 ? (
                <DeleteButton className="w-10 h-10 flex items-center justify-center rounded-md bg-gray-700/50 hover:bg-gray-600" />
              ) : (
                <button
                  onClick={onDecrement}
